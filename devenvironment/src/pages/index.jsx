    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="Babywise.life"
              link="https://babywise.life"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              Created several apps in support of the massive data undertaking behind this website.
            </ProjectCard>
            <ProjectCard
              title="Babyearth"
              link="https://babyearth.com"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              Created several apps that run various backend functions for the site.
            </ProjectCard>            
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt="Derek Kershner" />
            <AboutSub>
              Nearly all the software I have developed is serverless.
            </AboutSub>
          </AboutHero>
          <AboutDesc>

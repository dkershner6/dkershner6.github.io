...
<div className='page-header' style={{padding: 40}}>
 ...
 <h2>Serverless and Cloud from the start</h2>
  ...
  <Card.Body>    
  <p><Button href="https://www.linkedin.com/in/derek-kershner-54b3392">LinkedIn</Button></p>
  <p><Button href="https://github.com/dkershner6">GitHub</Button></p>
  <p><Button href="https://app.pluralsight.com/profile/dkershner">See what I am currently learning on Pluralsight</Button></p>
  </Card.Body>
  </Card>
  </Container>);
}

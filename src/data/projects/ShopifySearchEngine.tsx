    ...
    data: [
        ...
        },
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'A cache to house frequently requested data to improve performance',
                },
            ],
            reasons: [
    ...
    backend: [
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'Provide data to the Shopify Admin UI, allowing modification for logged in store owners',
                },
            ],
            reasons: [
        ...
        },
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'Through a combination of webhooks and polling, detect changes in the front end and hand them off to a queue',
                },
            ],
            reasons: [
        ...
        },
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'As a queue fills, make changes to the index according to the messages',
                },
            ],
            reasons: ['Azure Functions provides automatic integration with queues, enabling easy and quick development for this service.'],
        },
    ],
    frontend: [
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'Provide an Admin UI to store owners to make changes to how the search engine works',
                },
            ],
            reasons: [
        ...
        },
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'Provide the actual app that customers use to search the website, served through a proxy',
                },
            ],
            reasons: [

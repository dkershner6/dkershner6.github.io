...
const codeChallengesProject: IProject = {
    ...
    specification: ['These are generally tests handed out by interviewers to test coding prowess and vary widely.'],
    short: true,
    data: [],
    backend: [],
    frontend: [],
...
export const codeChallenges: ICodeChallenge[] = [
    {
        name: 'Automated Minesweeper',
        link: 'https://github.com/dkershner6/AutomatedMinesweeper',
        technology: technologies.filter(technology => technology.id === 'aspNetCore')[0],
        background:

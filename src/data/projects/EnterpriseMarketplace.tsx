...
const enterpriseMarketplaceProject: IProject = {
    id: 'enterpriseMarketplace',
    name: 'Enterprise Marketplace',
    imageSrc: '/img/supermarket.jpg',
    heroTint: '#001100',
    ...
    backend: [
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'Provide data to the front-end, allowing access and modification based on many access scopes',
                },
            ],
            reasons: [
        ...
        },
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'CRON service to do several data and maintenance tasks such as aggregation of Logistics Partner billing data',
                },
            ],
            reasons: [
        ...
        },
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'Handle all of the inward product and inventory data integrations from drop shippers',
                },
            ],
            reasons: [
        ...
        },
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'Handle changes from the seller module, creating things like new products and variants when necessary',
                },
            ],
            reasons: [
                'Azure Functions provides an easy to use code base for scheduled jobs (especially) and has nearly unlimited flexibility in terms of deployment and even language choice (this is like Lambdas for the AWS folks in the crowd, but can be deployed in containers).',
        ...
        },
        {
            ...
            attributes: [
                ...
                {
                    name: 'Note',
                    value: 'This is actually several deployments, but all are handled similarly',
                },
                {
                    name: 'Open Source',
                ...
                {
                    name: 'Function',
                    value: 'Handle all of the outward communication to the various sales channels (Shopify, Amazon, etc) for the marketplace products',
                },
            ],
            reasons: [
    ...
    frontend: [
        {
            ...
            attributes: [
                ...
                {
                    name: 'Function',
                    value: 'Provide an Authenticated portal for several different types of parties to log in and receive an experience custom to their user',
                },
            ],
            reasons: [

  ...
  return (
    <React.Fragment>
      ...
      <p className="mt-3">
        ...
        have a ton of experience as a user of online learning platforms and am a
        vehement supporter of the entire idea and industry. In my consulting
        experience, we actually were close to partnering with an Online
        University, and it has always been the idea I was most excited about. In
        addition, your stated values of honesty and integrity are critical to
        any business I would want to be involved in, and mirror my own
        requirements in co-workers.
      </p>
      <div>
        ...
        <ul>
          <li>
            ...
            releases. I have some Redux experience, but found it to be overkill
            for most of my project designs (likely not so for something as large
            as CBT Nuggets).
          </li>
          <li>
            ...
            small amount of time. I have tons of experience with Azure Functions
            (Lambda), Azure Storage Blobs (S3), and event-driven architectures
            like message queues and service buses (SQS).
          </li>
          <li>
          ...
          <li>
            I am both a heavy consumer and contributor to Open Source.
            ShopifySharp, the most popular .NET Shopify wrapper, is something I
            relied on heavily, and I am also one of top contributors as I
          ...
          <li>
            ...
            Proxies, and Containers. Throughout my experience, my favorite
            combination ended up being Kubernetes, Docker, and Nginx for larger
            projects, which appears to be a perfect match to what CBT uses.
          </li>
        </ul>

      ...
      <Jumbotron fluid className='mt-5'>
        <Container>
          <p className='text-muted'>
            ...
            to skin it. It's hosted on <a href='https://www.netlify.com/'
              target='_blank'
              rel='noopener noreferrer'>Netlify</a>, feel free to have a look at the{' '}
            <a
              href='https://github.com/dkershner6/dkershner6.github.io/'
              target='_blank'
              rel='noopener noreferrer'
            >
              open source code

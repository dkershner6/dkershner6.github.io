...
describe('Home', () => {
    it('renders without crashing', () => {
        ...
        ReactDOM.render(<HomePageTemplate image={data.image} title={data.title} heading={data.heading} subheading={data.subheading} />, div);
        ReactDOM.unmountComponentAtNode(div);
    });

    it('has correct heading and suheading', async () => {
        render(<HomePageTemplate image={data.image} title={data.title} heading={data.heading} subheading={data.subheading} />);
